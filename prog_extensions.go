...
var progExts []string = []string{
    ...
    ".cs", ".cake", ".cshtml", ".csx",
    // C++
    ".cpp", ".c++", ".cc", ".cp", ".cxx", ".h++", ".hh", ".hpp", ".hxx", ".inl", ".ipp", ".tcc", ".tpp", ".C", ".H",
    // C-ObjDump
    ".c-objdump",
    // C2hs Haskell
    ".chs",
    ...
    ".gd",
    // GLSL
    ".glsl", ".fp", ".frag", ".frg", ".fsh", ".fshader", ".geo", ".geom", ".glslv", ".gshader", ".shader", ".vert", ".vrx", ".vsh", ".vshader",
    // Genshi
    ".kid",
    // Gentoo Ebuild
    ".ebuild",
    ...
    ".dot", ".gv",
    // Groff
    ".man", ".1", ".1in", ".1m", ".1x", ".2", ".3", ".3in", ".3m", ".3qt", ".3x", ".4", ".5", ".6", ".7", ".8", ".9", ".me", ".rno", ".roff",
    // Groovy
    ".groovy", ".grt", ".gtpl", ".gvy",
    // Groovy Server Pages
    ".gsp",
    ...
    ".jsp",
    // JavaScript
    ".js", "._js", ".bones", ".es6", ".jake", ".jsb", ".jscad", ".jsfl", ".jsm", ".jss", ".njs", ".pac", ".sjs", ".ssjs", ".xsjs", ".xsjslib",
    // Julia
    ".jl",
    // Jupyter Notebook
    ".ipynb",
    ...
    ".pas", ".dfm", ".dpr", ".lpr",
    // Perl
    ".pl", ".al", ".perl", ".ph", ".plx", ".pm", ".psgi", ".t",
    // Perl6
    ".6pl", ".6pm", ".nqp", ".p6", ".p6l", ".p6m", ".pl6", ".pm6",
    // Pickle
    ".pkl",
    // PigLatin
    ".pig",
    ...
    ".purs",
    // Python
    ".py", ".bzl", ".gyp", ".lmi", ".pyde", ".pyp", ".pyt", ".pyw", ".tac", ".wsgi", ".xpy",
    // Python traceback
    ".pytb",
    // QML
    ".qml", ".qbs",
    ...
    ".rg",
    // Ruby
    ".rb", ".builder", ".gemspec", ".god", ".irbrc", ".jbuilder", ".mspec", ".podspec", ".rabl", ".rake", ".rbuild", ".rbw", ".rbx", ".ru", ".ruby", ".thor", ".watchr",
    // Rust
    ".rs", ".rs.in",
    // SAS
    ".sas",
    ...
    ".sqf", ".hqf",
    // SQL
    ".pls", ".pck", ".pkb", ".pks", ".plb", ".plsql", ".sql", ".cql", ".ddl", ".prc", ".tab", ".udf", ".viw", ".db2",
    // STON
    ".ston",
    // SVG
    ".svg",
    ...
    ".self",
    // Shell
    ".sh", ".bash", ".bats", ".command", ".ksh", ".sh.in", ".tmux", ".tool", ".zsh",
    // ShellSession
    ".sh-session",
    // Shen
    ".shen",
    ...
    ".xtend",
    // YAML
    ".yml", ".reek", ".rviz", ".sublime-syntax", ".syntax", ".yaml", ".yaml-tmlanguage",
    // YANG
    ".yang",
    // Yacc
    ".y", ".yacc", ".yy",
